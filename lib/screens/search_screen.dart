...
class _SearchScreenState extends State<SearchScreen> {
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    _buildTextField('Place of Origin', selectedOrigin ?? 'Select', 'origin'),
                    if (activeSelection == 'origin') ...[
                      const SizedBox(height: 16),
                      _buildOriginSelectionCard(),
                    ],
                    const SizedBox(height: 16),
                    _buildTextField('Church', selectedChurch ?? 'Select', 'church'),
                    if (activeSelection == 'church') ...[
                      const SizedBox(height: 16),
                      _buildChurchSelectionCard(),
                    ],
                    const SizedBox(height: 16),
                    _buildTextField('Reception', selectedReception ?? 'Select', 'reception'),
  ...
  Widget _buildOriginSelectionCard() {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
        color: Colors.white,
